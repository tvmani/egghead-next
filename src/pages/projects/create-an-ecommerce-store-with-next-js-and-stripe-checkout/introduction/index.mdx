...
_Note: this also includes a tutorial, which you can skip if you're following along with the workshop._
...
export const Sidebar = () => (
  <aside>
    ...
    <ul>
      <li>Get welcomed to the workshop</li>
      <li>Understand what you'll learn</li>
    </ul>
  </aside>
)
